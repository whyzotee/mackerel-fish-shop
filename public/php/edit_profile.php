      ...
      <table width="400" border="1" style="width: 400px">
        <tbody>
          <tr>
            ...
            <td width="180"><?php echo $result["test_id"];?></td>
          </tr>
          <tr>
            <td> &nbsp;ชื่อผู้ใช้ :</td>
            <td><?php echo $result["test_user"];?></td>
          </tr>
          <tr>
            <td> &nbsp;รหัสผ่าน :</td>
            <td><input name="txtPassword" type="password" id="txtPassword" value="<?php echo $result["test_pass"];?>"></td>
          </tr>
          <tr>
            <td> &nbsp;ยืนยัน รหัสผ่าน :</td>
            <td><input name="txtConPassword" type="password" id="txtConPassword" value="<?php echo $result["test_pass"];?>"></td>
          </tr>
          <tr>
            <td>&nbsp;ชื่อ :</td>
          ...
          <tr>
            <td> &nbsp;สถานะ :</td>
            <td><?php echo $result["test_status"];?></td>
          </tr>
        </tbody>
      </table>
      <br>
